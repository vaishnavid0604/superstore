...
<div class="col-sm-12 mb-3">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-warning" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Distributor Login</a>
           ...
           <div class="card card-body bg-gradient-warning">
                ...
                <form  method="post" action="">     
                    ...
                    <label for="name" class="col-md-3 col-form-label"
                      ><h6 class="text-white font-weight-bold">Distributor ID</h6>
                    </label>
                    <div class="col-md-9">
                      <input
                        type="text"
            ...
            <div class="input-group mb-3">
              ...
              <input name="lspass" type="password"  class="input form-control" id="password" placeholder="password" required="true" aria-label="password" aria-describedby="basic-addon1" />
