			...
			<li class="nav-item">
              <a href="stored.php" class="nav-link">
                <span class="text-success nav-link-inner--text font-weight-bold"
                  ><i class="text-success fas fa-user-circle"></i> Store Details</span
                >
              </a>
            </li>
...
<div class="container ">
    	 ...
    	 <div class="row">
          <div class="col-md-8 mx-auto text-center">
            <span class="badge badge-danger badge-pill mb-3">Stores</span>
          </div>
        </div>
          ...
          <div class="row row-content">
            <div class="col-md-12 mb-3">
				...
				<div class="card text-white bg-gradient-warning mb-3">
				  ...
				  <span class=" text-warning display-4" > Store Details  </span>
				  
					 <button class=" btn btn-success pull-right" data-toggle="modal" data-target="#store">
                        ADD
                      </button>
				  </div>
